...
public class calculator67 {
        ...
        static boolean historySaved = false;
        ...
        static void runBasicCalculator(Scanner sc) {
            ...
            do {
                ...
                switch (choice) {
                    ...
                    case 9 -> saveHistoryToFile();
                    case 11 -> markFavorite();
                    case 12 -> viewFavorites(sc);
                    case 0 -> {
                        if (confirmExit(sc)) return;
                    }
        ...
        static void markFavorite() {
            System.out.println("You have selected: Mark as favorite");
        ...
        static boolean confirmExit(Scanner sc) {
            if (!historySaved && !history.isEmpty()) {
                System.out.println("You have " + history.size() + " operations in your history that haven't been saved.");
            }
        ...
        static void saveHistoryToFile() {
            try (FileWriter fw = new FileWriter("calculator_history.txt")) {
                for (String entry : history) {
                    fw.write(entry + "\n");
                }
                historySaved = true;
                System.out.println("History saved to file: calculator_history.txt");
            } catch (IOException e) {
        ...
        static void showBasicMenu() {
            ...
            System.out.println("9. Save history");
