        ...
        while (true) {
            ...
            switch (op) {
                case 1, 2, 3, 4 -> {
                    ...
                    double num2 = sc.nextDouble();
                    switch (op) {
                        case 1 -> System.out.println("Result: " + (int)num1 + "+" + (int)num2 + "=" + (num1 + num2));
                        case 2 -> System.out.println("Result: " + (int)num1 + "-" + (int)num2 + "=" + (num1 - num2));
                        case 3 -> System.out.println("Result: " + (int)num1 + "*" + (int)num2 + "=" + (num1 * num2));
                        case 4 -> {
                            if (num2 == 0) {
                                System.out.println("Error: Division by zero!");
                            } else {
                                System.out.println("Result: " + (int)num1 + "/" + (int)num2 + "=" + (num1 / num2));
                            }
                        }
                    }
                }
                case 5 -> {
                    ...
                    System.out.println("Result: " + (int)base + "^" + (int)exp + "=" + Math.pow(base, exp));
                }
                case 6 -> {
                    System.out.print("Enter first number: ");
                    int num1 = sc.nextInt();
                ...
                case 7 -> {
                    ...
                    System.out.println("Result: sqrt(" + (int)num + ") = " + Math.sqrt(num));
                }
                default -> System.out.println("Invalid operation.");
            }
        }
